...
import '../../feature/home/domain/use_cases/get_users_usercase.dart' as _i17;
import '../../feature/home/presentation/manager/home_bloc.dart' as _i18;
import '../../feature/profile/profile/data/data_sources/local_data_source.dart'
    as _i8;
import '../../feature/profile/profile/data/data_sources/remote_data_source.dart'
    as _i9;
import '../../feature/profile/profile/data/repositories/profile_repository.dart'
    as _i15;
import '../../feature/profile/profile/domain/repositories/i_profile_repository.dart'
    as _i14;
import '../../feature/profile/profile/domain/use_cases/get_profile_usecase.dart'
    as _i16;
import '../../feature/profile/profile/presentation/manager/profile_bloc.dart'
    as _i19;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i17.GetUsersUseCase>(
      () => _i17.GetUsersUseCase(get<_i12.IHomeRepository>()));
  gh.factory<_i18.HomeBloc>(() => _i18.HomeBloc(get<_i17.GetUsersUseCase>()));
  gh.factory<_i19.ProfileBloc>(
      () => _i19.ProfileBloc(get<_i16.GetProfileUseCase>()));
  return get;
}
